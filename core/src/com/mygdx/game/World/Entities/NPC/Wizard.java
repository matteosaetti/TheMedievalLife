...
public class Wizard extends NPC{
    public Wizard(World world, Vector2 coords, AssetManager assetManager) {
        super(world, 0.5f, 0.55f, coords);

        setNPCname("Wizard");
        setConversationConfigPath("NPC/Wizard/dialog.json");
        setNpcAnimation(new OnlyIdleAnimation(assetManager, "NPC/Wizard/idle1.atlas"));
    }
