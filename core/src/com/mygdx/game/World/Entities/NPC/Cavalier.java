...
public class Cavalier extends NPC{
    public Cavalier(World world, Vector2 coords, AssetManager assetManager) {
        super(world, 0.5f, 0.55f, coords);

        setNPCname("Cavalier");
        setConversationConfigPath("NPC/Cavalier/dialogue.json");
